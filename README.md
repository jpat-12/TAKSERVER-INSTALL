...
```bash
sudo yum install git && cd /tmp && git clone https://github.com/jpat-12/TAKSERVER-INSTALL.git && cd TAKSERVER-INSTALL && sudo chmod +x depend-rpm.sh && ./depend-rpm.sh && sudo chmod +x centos.sh && clear && echo "run ./centos.sh to install takserver" && cd /home/atak/Downloads
```
```bash
